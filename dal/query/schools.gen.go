...
func newSchool(db *gorm.DB, opts ...gen.DOOption) school {
	...
	_school.CreatedAt = field.NewTime(tableName, "created_at")
	_school.UpdatedAt = field.NewTime(tableName, "updated_at")
	_school.DeletedAt = field.NewField(tableName, "deleted_at")
...
func (s *school) WithContext(ctx context.Context) ISchoolDo { return s.schoolDo.WithContext(ctx) }

func (s school) TableName() string { return s.schoolDo.TableName() }

func (s school) Alias() string { return s.schoolDo.Alias() }

func (s school) Columns(cols ...field.Expr) gen.Columns { return s.schoolDo.Columns(cols...) }
