...
func newInfo(db *gorm.DB, opts ...gen.DOOption) info {
	...
	_info.Sid = field.NewString(tableName, "sid")
	_info.ClassID = field.NewInt64(tableName, "class_id")
	_info.Name = field.NewString(tableName, "name")
	_info.Gender = field.NewString(tableName, "gender")
	_info.Email = field.NewString(tableName, "email")
	_info.Telephone = field.NewString(tableName, "telephone")
...
func (i *info) updateTableName(table string) *info {
	...
	i.Sid = field.NewString(table, "sid")
	i.ClassID = field.NewInt64(table, "class_id")
	i.Name = field.NewString(table, "name")
	i.Gender = field.NewString(table, "gender")
	i.Email = field.NewString(table, "email")
	i.Telephone = field.NewString(table, "telephone")
...
func (i *info) WithContext(ctx context.Context) IInfoDo { return i.infoDo.WithContext(ctx) }

func (i info) TableName() string { return i.infoDo.TableName() }

func (i info) Alias() string { return i.infoDo.Alias() }

func (i info) Columns(cols ...field.Expr) gen.Columns { return i.infoDo.Columns(cols...) }
...
func (i *info) fillFieldMap() {
	...
	i.fieldMap["id"] = i.ID
	i.fieldMap["sid"] = i.Sid
	i.fieldMap["class_id"] = i.ClassID
	i.fieldMap["name"] = i.Name
	i.fieldMap["gender"] = i.Gender
	i.fieldMap["email"] = i.Email
	i.fieldMap["telephone"] = i.Telephone
}
