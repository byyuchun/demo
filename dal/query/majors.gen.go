...
func newMajor(db *gorm.DB, opts ...gen.DOOption) major {
	...
	_major.CreatedAt = field.NewTime(tableName, "created_at")
	_major.UpdatedAt = field.NewTime(tableName, "updated_at")
	_major.DeletedAt = field.NewField(tableName, "deleted_at")
	_major.Name = field.NewString(tableName, "name")
	_major.SchoolID = field.NewInt64(tableName, "school_id")
...
func (m *major) updateTableName(table string) *major {
	...
	m.SchoolID = field.NewInt64(table, "school_id")
...
func (m major) Columns(cols ...field.Expr) gen.Columns { return m.majorDo.Columns(cols...) }
...
func (m *major) fillFieldMap() {
	...
	m.fieldMap["school_id"] = m.SchoolID
}
