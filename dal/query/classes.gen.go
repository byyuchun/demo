...
func newClass(db *gorm.DB, opts ...gen.DOOption) class {
	...
	_class.DeletedAt = field.NewField(tableName, "deleted_at")
	_class.Name = field.NewString(tableName, "name")
	_class.MajorID = field.NewInt64(tableName, "major_id")
	_class.SchoolID = field.NewInt64(tableName, "school_id")
...
func (c *class) updateTableName(table string) *class {
	...
	c.SchoolID = field.NewInt64(table, "school_id")
...
func (c *class) fillFieldMap() {
	...
	c.fieldMap["school_id"] = c.SchoolID
}
